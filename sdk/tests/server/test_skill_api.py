...
from agent_sdk._server.skill_api import _resolve_skill_md_url
...
class TestSkillApiEndpoints:
    ...
    def client(self) -> TestClient:
        from agent_sdk._server.app import app
    ...
    def test_install_and_uninstall_flow(self, client: TestClient, tmp_path: Path) -> None:
        ...
        with patch("agent_sdk._server.skill_api.get_agent_fs_backend", return_value=skills_backend), \
             patch("agent_sdk._server.skill_api.httpx.AsyncClient") as mock_client_cls:
            # Mock HTTP response
            mock_resp = AsyncMock()
