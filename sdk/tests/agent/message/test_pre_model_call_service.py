...
from agent_sdk._agent.message.attachment_collector import AttachmentCollector, _ATTACHMENT_SOURCE
...
class TestHandleWithCompact:
    async def test_compacted_true_when_microcompact_triggers(self, tmp_path: Path) -> None:
        ...
        from agent_sdk._agent.message.history_message_loader import _serialize_messages
        ...
        from agent_sdk._agent.compact.token_counter import estimate_messages_tokens
