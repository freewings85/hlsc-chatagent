...
from agent_sdk._agent.message.history_message_loader import HistoryMessageLoader, _deserialize_messages
...
class TestHistoryLoaderBackendFailure:
    ...
    async def test_append_read_failure_raises(self, tmp_path) -> None:
        ...
        async def failing_download(paths: list[str]) -> list:
            from agent_sdk._common.filesystem_backend import FileDownloadResponse
