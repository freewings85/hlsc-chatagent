...
from agent_sdk._agent.compact.compactor import CompactResult, Compactor, _PLACEHOLDER
...
class TestCompactWithPersistence:
    ...
    async def test_microcompact_saves_to_file(self, tmp_path) -> None:
        ...
        from agent_sdk._agent.agent_message import UserMessage as AgentUserMessage
