...
启动方式：
    ...
    uv run python src/hlsc/subagents/price_finder/server.py --env src/hlsc/subagents/price_finder/.env.local
    uv run python src/hlsc/subagents/price_finder/server.py --port 8101
"""
...
def main() -> None:
    ...
    from src.hlsc.subagents.price_finder.tools import create_price_finder_tool_map
