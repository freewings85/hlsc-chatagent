  ...
  return (
    <>
      <div className="header">
        <div>
          <h1>Skill Manager</h1>
          <span className="subtitle">ChatAgent Skill 管理</span>
        </div>
      </div>
      ...
      <div className="install-section">
        ...
        <form className="install-form" onSubmit={handleInstall}>
          <input
            ...
            placeholder="GitHub URL 或 SKILL.md 直链，例如 https://github.com/anthropics/openclaw/tree/main/skills/github"
            disabled={installing}
          />
            ...
            {skills.map(skill => (
              <div key={skill.name} className="skill-card">
                <div className="skill-info">
                  ...
                  {skill.when_to_use && (
                    <div className="skill-when">{skill.when_to_use}</div>
                  )}
                </div>
      ...
      <div className="help-section">
        ...
        <ul>
          ...
          <li>任意 HTTPS URL（需直接指向 SKILL.md 文件）</li>
        </ul>
      </div>
    </>
  )
