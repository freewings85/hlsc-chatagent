...
from searchshops.case4_compare_prices.mock_data import SHOPS, SHOP_EVENTS, PROJECTS, QUOTATIONS
...
async def run() -> bool:
    ...
    print(f"\n{_C}>>> Step 5: 运行测试{_0}")
    from searchshops.case4_compare_prices.test_case import test_compare_prices
    passed: bool = await test_compare_prices()
