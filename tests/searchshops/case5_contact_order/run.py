...
from searchshops.case5_contact_order.mock_data import SHOPS, SHOP_EVENTS, PROJECTS, QUOTATIONS
...
async def run() -> bool:
    ...
    print(f"\n{_C}>>> Step 5: 运行测试{_0}")
    from searchshops.case5_contact_order.test_case import test_contact_order
    passed: bool = await test_contact_order()
