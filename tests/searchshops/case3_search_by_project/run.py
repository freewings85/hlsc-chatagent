...
from searchshops.case3_search_by_project.mock_data import SHOPS, SHOP_EVENTS, PROJECTS, QUOTATIONS
...
async def run() -> bool:
    ...
    print(f"\n{_C}>>> Step 5: 运行测试{_0}")
    from searchshops.case3_search_by_project.test_case import test_search_by_project
...
def main() -> None:
    print(f"\n{_B}{'=' * 60}{_0}")
    print(f"{_B}SS-003: 按项目搜索门店 — 全流程{_0}")
    print(f"{_B}{'=' * 60}{_0}")
