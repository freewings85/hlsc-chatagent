...
from searchshops.case6_text_address.mock_data import SHOPS, SHOP_EVENTS, PROJECTS, QUOTATIONS
...
async def run() -> bool:
    ...
    print(f"\n{_C}>>> Step 5: 运行测试{_0}")
    from searchshops.case6_text_address.test_case import test_text_address
    passed: bool = await test_text_address()
