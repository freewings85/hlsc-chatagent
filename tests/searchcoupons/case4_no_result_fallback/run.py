...
from searchcoupons.case4_no_result_fallback.mock_data import (
    SHOPS, SHOP_EVENTS, PROJECTS, QUOTATIONS,
)
...
async def run() -> bool:
    ...
    print(f"\n{_C}>>> Step 3: Seed Kafka（仅商户，不造优惠）{_0}")
    ...
    print(f"\n{_C}>>> Step 5: 运行测试{_0}")
    from searchcoupons.case4_no_result_fallback.test_case import test_no_result_fallback
    passed: bool = await test_no_result_fallback()
