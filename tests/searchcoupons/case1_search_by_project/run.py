...
from searchcoupons.case1_search_by_project.mock_data import (
...
async def run() -> bool:
    ...
    print(f"\n{_C}>>> Step 5: 运行测试{_0}")
    from searchcoupons.case1_search_by_project.test_case import test_search_by_project
    passed: bool = await test_search_by_project()
