...
from searchcoupons.case3_book_coupon.mock_data import (
...
async def run() -> bool:
    ...
    print(f"\n{_C}>>> Step 5: 运行测试{_0}")
    from searchcoupons.case3_book_coupon.test_case import test_book_coupon
    passed: bool = await test_book_coupon()
