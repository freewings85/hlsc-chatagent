...
```bash
python scripts/search_parts.py --keyword 刹车片 --car_model_id CAR-001
```

工作目录为当前 skill 目录（`skills/query-part-price/`）。
...
```bash
python scripts/get_part_price.py --part_ids 123 --car_model_id CAR-001
```
