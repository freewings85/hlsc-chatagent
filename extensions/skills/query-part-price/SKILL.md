...
- skill_name: `query-part-price`
- script_path: `scripts/search_parts.py`
- args: `--keyword 刹车片 --car_model_id CAR-001`
...
确认 part_id 后，调用 `execute_skill_script`：
- skill_name: `query-part-price`
- script_path: `scripts/get_part_price.py`
- args: `--part_ids 123 --car_model_id CAR-001`
