"""search_discount 工具：根据项目和商户查询可用的优惠活动。
...
_DESCRIPTION: str = load_tool_prompt("search_discount")
...
async def search_discount(
    ...
    log_tool_start("search_discount", sid, rid, {
    ...
    try:
        async with httpx.AsyncClient(timeout=10.0) as client:
            ...
            log_tool_end("search_discount", sid, rid, {
        ...
        log_tool_end("search_discount", sid, rid, exc=e)
        return f"Error: search_discount failed - {e}"


search_discount.__doc__ = _DESCRIPTION
