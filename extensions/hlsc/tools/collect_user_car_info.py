"""collect_user_car_info 工具：触发车辆信息收集界面，按所需精度收集车辆信息。"""
...
_DESCRIPTION = load_tool_prompt("collect_user_car_info")


async def collect_user_car_info(
    ...
    try:
        ...
        try:
            ...
            if precision_ok:
                log_tool_end("collect_user_car_info", sid, rid, {
        ...
        log_tool_end("collect_user_car_info", sid, rid, exc=e)
        return f"Error: collect_user_car_info failed - {e}"


collect_user_car_info.__doc__ = _DESCRIPTION
